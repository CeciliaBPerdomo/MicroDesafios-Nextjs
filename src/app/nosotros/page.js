...
export default function Nosotros() {
    return (
        <main className="container m-auto">
            ...
            <div className="">
                <p className="text-lg">Bienvenidos a <b className="text-red-600">Electrodomésticos Capellari</b>, una tradición
                ...
                <p className="text-lg"><b>Nuestra Historia</b>: Desde nuestros humildes comienzos en 1843,
                ...
                <p><b>Valores Fundamentales</b>: En Electrodomésticos Capellari, valoramos la importancia de la
                ...
                <p><b>Selección Excepcional</b>: Explora nuestro extenso catálogo de electrodomésticos de las
                ...
                <p><b>Compromiso con la Calidad</b>: En Electrodomésticos Capellari, entendemos que los electrodomésticos
                ...
                <p><b>Servicio Personalizado</b>: Nuestro equipo altamente capacitado y amable está aquí para
                ...
                <p><b>Un Futuro Sostenible</b>: Nos preocupamos por el medio ambiente y trabajamos constantemente
                ...
                <p><b>Únete a Nuestra Familia</b>: Ya sea que estés buscando renovar tu hogar con lo último en
